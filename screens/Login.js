   ...
   <View style={styles.container}>
       <ImageBackground source={require('../assets/login_pic.jpg')} style={styles.image_bg}>
           ...
           <View style={styles.bottomView}>
               <TextInput onChangeText={onChangePhone} value={phone} placeholder=" Numero de telephone" keyboardType="numeric" maxLength={15} style={styles.textInput}/>
               ...
               <TouchableOpacity activeOpacity={0.6} style={styles.loginView}>
